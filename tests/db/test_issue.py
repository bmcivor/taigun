...
class TestIssueWriter:
    def test_returns_ref(self, mock_conn):
        ...
        """
        writer = IssueWriter(mock_conn, make_resolver())
    ...
    def test_resolves_project(self, mock_conn):
        ...
        writer = IssueWriter(mock_conn, mock_resolver)
        with patch("taigun.db.base.datetime.datetime") as mock_dt:
            mock_dt.now.return_value = FIXED_NOW
    ...
    def test_resolves_issue_type_when_set(self, mock_conn):
    ...
    def test_resolves_issue_type_none_passes_none(self, mock_conn):
    ...
    def test_resolves_severity_when_set(self, mock_conn):
    ...
    def test_resolves_severity_none_passes_none(self, mock_conn):
